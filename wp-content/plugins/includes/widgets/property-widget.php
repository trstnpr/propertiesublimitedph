...
class Property_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'property_widget', 'Properties', $widget_ops );

	}

	public static function init(){

		add_action('widgets_init', array( __CLASS__ , 'register_property_widget'));
	}
  ...
  return $instance;
	...
	public static function register_property_widget() {
    register_widget('Property_Widget');
}

}

Property_Widget::init();