...
$subtitle = get_theme_mod('about_sub_title');
$first = get_theme_mod('first_about');


?>
<div class="section grey about">
	<div class="grid">
	...
	if ( has_post_thumbnail() ) { ?>
		<div class='page-thumb'>
				...
				<?php the_post_thumbnail('realest_property_slide'); ?>
				</a>
		</div>
		<?php } ?>
		</div>
	...
	<h5 class="section-sub-title"> <?php echo esc_html( $subtitle) ; ?></h5>
		...
		$output .= '<div class="about-excerpt">';
		$output .=  the_excerpt(); 
		$output .= '<a class="read_more" href="'. esc_url(get_the_permalink()) .'"> '. esc_html("Read More","realest").'';
		$output .=  '</a></div>';
