...
$wizard = new Merlin(
	...
	$strings = array(
		...
		'welcome-header%s' 		=> esc_html__( 'Welcome to Real Estate PRO' , '@@textdomain' ),
		...
		'plugins' 			=> esc_html__( 'Let’s install some essential WordPress plugins to get your site up to speed.(might take up to 5 minutes)' , '@@textdomain' ),
		...
		'import' 			=> esc_html__( 'Let’s import content to your website, to help you get familiar with the theme.(might take up to 10 minutes)' , '@@textdomain' ),
		...
		'license-link-1'            	=> wp_kses( sprintf( __( '<a href="http://support.thepixeltribe.com" target="_blank">%s</a>', '@@textdomain' ), 'Documentation' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'license-link-2'            	=> wp_kses( sprintf( __( '<a href="https://thepixeltribe.com/contact/" target="_blank">%s</a>', '@@textdomain' ), 'Get Theme Support' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		...
		'ready-link-1'              	=> wp_kses( sprintf( __( '<a href="https://support.thepixeltribe.com" target="_blank">%s</a>', '@@textdomain' ), 'Documentation' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'ready-link-2'              	=> wp_kses( sprintf( __( '<a href="https://thepixeltribe.com/contact/" target="_blank">%s</a>', '@@textdomain' ), 'Get Theme Support' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
